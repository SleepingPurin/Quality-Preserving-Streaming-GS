...
def load_lazy_blender_image(cam_info, white_background):
...
def loadCam(args, id, cam_info, resolution_scale):
    if cam_info.image is None:
        image_source, loaded_mask = load_lazy_blender_image(cam_info, args.white_background)
    else:
        image_source = cam_info.image
    ...
    resized_image_rgb = PILtoTorch(image_source, resolution)
